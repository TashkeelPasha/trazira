...
\
  ...
  if (window.matchMedia("(max-width: 600px)").matches) {
    timeline.to(".page1-video video", {
      width: "90%",
      scrollTrigger: {
        trigger: ".page1-video video",
        scroller: "",
...
// Timeline Animation with GSAP ScrollTrigger
// const timeline = document.querySelector(".timeline");
// const timelineContainers = document.querySelectorAll(".timeline-container");

// if (timeline && timelineContainers.length > 0) {
//   // Add the "show" class to timeline containers when they come into view
...
//     timeline,
//     {
//       scaleY: 0, // Start with the line hidden
//     },
//     {
//       scaleY: 1, // Fully visible line
//       scrollTrigger: {
//         trigger: timeline,
//         start: "top 80%", // Adjust this value as needed
//         end: "bottom 20%",
...
// Show Modal
document
  .getElementById("open-simple-modal")
  .addEventListener("click", function () {
    document.getElementById("simple-modal").classList.add("show-simple-modal");
  });

// Close Modal
document
  .getElementById("close-simple-modal")
  .addEventListener("click", function () {
    document
      .getElementById("simple-modal")
      .classList.remove("show-simple-modal");
  });
...
window.addEventListener("click", function (e) {
  const modal = document.getElementById("simple-modal-box");
  if (e.target === document.getElementById("simple-modal")) {
    document
      .getElementById("simple-modal")
      .classList.remove("show-simple-modal");
  }
